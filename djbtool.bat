: DJBTool v1.07 Batch Script created by djb77 / XDA Developers
...
@echo off
cd "%~dp0"
if not exist "%LOCALAPPDATA%/apktool/framework/" (mkdir "%LOCALAPPDATA%/apktool/framework")
